...
class CoverageReportGenerator:
    ...
    def __init__(self, project_root: Optional[Path] = None):
        ...
        self.scripts_dir = self.coverage_dir
    ...
    def _gather_metadata(self) -> None:
        ...
        try:
            ...
            env_info = {
                ...
                'scripts_directory': str(self.coverage_dir)
            }
    ...
    def _upload_github_artifacts(self, reports: Dict[str, Path]) -> None:
        ...
        try:
            # Create artifacts directory under scripts/coverage
            artifacts_dir = self.coverage_dir / 'artifacts'
